...
- Fix `SolverKamino` silently truncating NumPy int64 inputs that exceed the int32 range during model construction; conversions now raise `OverflowError` with the offending value range.
