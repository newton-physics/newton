...
- Add `SensorTiledCamera.set_shape_texture_ids()` for assigning textured rendering IDs per shape or per render world, enabling batched camera domain randomization without rebuilding the render context.
