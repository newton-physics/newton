...
- Add `viewer.set_picking_torque_scale()` to scale the mouse-picking lever arm from the center of mass to the clicked point; cable examples use center-of-mass dragging to improve stability.
