...
- Document loop closure in the articulations concept page, covering both the `add_equality_constraint_*` and orphan-joint (omit-from-`add_articulation`) approaches with per-solver caveats
