...
- Fix MJCF mesh scale resolution using geom's default class instead of the mesh asset's own class, causing incorrect vertex scaling for models like Robotiq 2F-85 V4
