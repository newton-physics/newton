...
- Add `SensorContact.contact_position_matrix` for per-counterpart world-frame contact positions (force-weighted average of contact midpoints; NaN where no contacts contribute).
- Add `SensorContact.contact_position_matrix` for per-counterpart world-frame contact positions (force-weighted average of contact midpoints; zero where no contacts contribute).
