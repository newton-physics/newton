...
- Add USD parsing for contact penalty attributes on `NewtonCollisionAPI`
- Document `NewtonCollisionAPI` and `NewtonMeshCollisionAPI` in collision USD integration guide
