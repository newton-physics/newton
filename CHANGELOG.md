...
- Add opt-in `ViewerUSD(points_as_spheres=True)` to render `log_points` particles as a `UsdGeom.PointInstancer` of sphere prototypes instead of the default flat `UsdGeom.Points` splats
