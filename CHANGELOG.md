...
- Replace the combined `Contacts.force` extended attribute with `Contacts.rigid_contact_wrench` (rigid wrench at the contact midpoint, sign "body 0 on body 1") and `Contacts.soft_contact_force`; `Contacts.rigid_contact_wrench` also subsumes the former `Contacts.rigid_contact_force` attribute.
...
- Deprecate the `Contacts.rigid_contact_force` attribute in favor of `Contacts.rigid_contact_wrench`.
- Deprecate the unused `Contacts.rigid_contact_point_id` attribute.
...
- Remove the combined `Contacts.force` extended attribute and `"force"` request key; use `Contacts.rigid_contact_wrench` and `Contacts.soft_contact_force` instead.
