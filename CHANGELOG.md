...
- Add experimental deformable visual meshes with procedural builder and USD import support, shared `DeformableVisuals` points and normals across viewers and `SensorTiledCamera` RGB/depth output, and textured cable/cloth/volume examples with procedural/USD setup modes and independent coarse-surface visibility.
