...
- Fix mesh collision sign queries to use parity for watertight meshes and the normal-based method for non-watertight meshes; set `ShapeFlags.MESH_SIGN_NORMAL` or `ShapeFlags.MESH_SIGN_PARITY` to override the automatic choice. (#3242)
