...
- Add metadata-driven `ModelView` compaction for custom attributes, including non-prefix selections, custom-frequency and compound references, negative sentinels, and view-local namespace overlays.
