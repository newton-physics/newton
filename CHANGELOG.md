...
- Fix `SensorTiledCamera` rendering cloth triangle-mesh vertices as particle spheres while preserving standalone particle rendering in mixed cloth/particle scenes.
