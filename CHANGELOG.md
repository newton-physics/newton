...
- Add portable stiffness and damping to mimic constraints through `ModelBuilder.add_constraint_mimic()`, `Model.constraint_mimic_stiffness` / `constraint_mimic_damping`, `NewtonMimicAPI` USD import, and MuJoCo force-space compliance conversion. (#3309)
