...
- Keep Newton joint-limit stiffness and damping defaults when importing MJCF instead of deriving generic gains from MuJoCo's `solreflimit`; preserve native values through MuJoCo-specific attributes. (#3762)
