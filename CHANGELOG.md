...
- Add per-layer solid-color overrides, opacity, and caller-supplied model-shape visibility in `ViewerGL` through `LayerRenderStyle`, `ViewerBase.set_layer_render_style()`, and `ViewerBase.set_layer_shape_visibility()`.
