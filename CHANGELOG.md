...
- Add opt-in inclusion of collision shapes in model shape BVHs through `Model.bvh_build_shapes(include_collision_shapes=True)` and `ModelBuilder.default_bvh_cfg.include_collision_shapes`.
