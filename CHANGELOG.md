...
- Add `Model.shape_collision_filter_contains()` and `Model.shape_collision_filter_pairs_for_broad_phase()` for solver integrations that need collision-filter queries.
