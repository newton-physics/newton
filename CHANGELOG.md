...
- Improve tiled camera sensor rendering performance by clearing output images with array fills before rendering instead of per-pixel clear writes in the render kernel.
