...
- Fix `SolverMuJoCo` to warn at construction when non-default finite `Model.joint_velocity_limit` values are ignored because MuJoCo has no equivalent hard joint-velocity clamp.
