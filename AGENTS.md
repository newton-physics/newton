...
- When tuning a simulation — instability, contact, drive, or solver-parameter work — use the `simulation-tuning` skill, which routes to `docs/concepts/simulation_tuning.rst` and its sub-pages.
