...
<table>
  ...
  <tr>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/sensors/example_sensor_texture_randomization.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_sensor_texture_randomization.jpg" alt="Sensor Texture Randomization">
      </a>
    </td>
    <td align="center" width="33%">
    </td>
  ...
  <tr>
    <td align="center" width="33%">
      <code>python -m newton.examples sensor_texture_randomization</code>
    </td>
    <td align="center" width="33%">
    </td>
    <td align="center" width="33%">
