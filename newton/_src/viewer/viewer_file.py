...
class ViewerFile(ViewerBase):
    ...
    def log_mesh(
        ...
        *,
        roughness_texture: Mesh.Texture | np.ndarray | str | None = None,
        ...
        Args:
            ...
            roughness_texture: Optional linear roughness texture (not recorded by this no-op method).
            roughness_texture_influence: Blend weight between scalar and texture roughness (not recorded).
        """
        pass
