...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        self.mesh_bvh_constructor: str | None = None
        """Warp mesh BVH constructor used when finalizing mesh geometry, or ``None`` for Warp's default."""
        ...
        self.gaussian_bvh_constructor: str | None = None
        """Warp BVH constructor used when finalizing Gaussian geometry, or ``None`` for Warp's default."""
