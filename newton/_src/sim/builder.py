    ...
    def add_joint_cable(
        ...
        **kwargs,
        ...
        .. note::
            ...
            AVBD backend for rigid bodies. Split cables use each anchor frame's
            local ``+Z`` as the material tangent axis for separating axial stretch
            from shear and twist from bend. For a body-to-body cable span, the
            parent anchor ``+Z`` should point from the parent attachment toward
            the child attachment. :meth:`add_rod` and :meth:`add_rod_graph`
            satisfy the tangent convention automatically.
        ...
        Args:
            ...
            bend_damping: Cable bend damping (stored as ``target_kd``). In
                :class:`newton.solvers.SolverVBD` this is a dimensionless
