...
class ContactWriterData:
    ...
    out_elastic_sample0: wp.array[wp.int32]
    out_elastic_sample1: wp.array[wp.int32]
...
def write_contact_speculative(
    ...
    body0 = writer_data.shape_body[contact_data.shape_a]
    body1 = writer_data.shape_body[contact_data.shape_b]
    if (body0 >= 0 and writer_data.body_elastic_index[body0] >= 0) or (
        body1 >= 0 and writer_data.body_elastic_index[body1] >= 0
    ):
        if output_index >= 0 and output_index < writer_data.contact_max:
            writer_data.out_shape0[output_index] = -1
            writer_data.out_shape1[output_index] = -1
        ...
        *,
        ...
        if self.deterministic and self._contact_sorter is not None:
            self._contact_sorter.sort_full(
                ...
                elastic_sample0=contacts.rigid_contact_elastic_sample0,
                elastic_sample1=contacts.rigid_contact_elastic_sample1,
                device=self.device,
            )
