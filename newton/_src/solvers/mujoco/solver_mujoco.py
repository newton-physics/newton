...
@wp.kernel
def zero_selected_rows_float_matrix_kernel(world_ids: wp.array[wp.int32], values: wp.array2d[wp.float32]):
...
@wp.kernel
def zero_selected_entries_int_vector_kernel(world_ids: wp.array[wp.int32], values: wp.array[wp.int32]):
    tid = wp.tid()
