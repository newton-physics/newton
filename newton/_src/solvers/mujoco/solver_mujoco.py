...
class SolverMuJoCo(SolverBase):
    ...
    def step(self, state_in: State, state_out: State, control: Control, contacts: Contacts, dt: float):
        ...
        if self.use_mujoco_cpu:
            ...
            self._update_newton_state(self.model, state_out, self.mj_data, eval_fk=eval_fk)
        else:
            ...
            self._update_newton_state(self.model, state_out, self.mjw_data, eval_fk=eval_fk)
        self._step += 1
        return state_out
