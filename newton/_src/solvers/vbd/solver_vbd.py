...
class SolverVBD(SolverBase):
    ...
    and twist default to soft mode. The hard/soft mode can be changed per
    slot via :meth:`set_joint_constraint_mode`.
    ...
    def __init__(
        ...
        Note:
            ...
            - Dahl hysteresis friction for cable bend/twist is auto-detected from custom model attributes
    ...
    def notify_model_changed(self, flags: int) -> None:
        ...
        if flags & (SolverNotifyFlags.JOINT_PROPERTIES | SolverNotifyFlags.BODY_PROPERTIES):
            self._refresh_cable_rest_bend_twist_cache()
    ...
    def register_custom_attributes(cls, builder: ModelBuilder) -> None:
        ...
        Currently used for:
          - Cable angular plasticity/hysteresis (Dahl friction model)
          - Per-joint hard/soft default for non-cable structural constraints
    ...
    def set_joint_constraint_mode(self, joint_index: int, hard: bool, slot: int | None = None):
        ...
        Intended for configuration before the first :meth:`step`. It only flips
        per-slot hard flags.
