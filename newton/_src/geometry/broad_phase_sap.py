...
def _create_tile_sort_kernel(tile_size: int):
    ...
    def tile_sort_kernel(
        sap_projection_lower: wp.array1d[float],
        sap_sort_index: wp.array1d[int],
...
def _sap_project_kernel(
    ...
    shape_bounding_box_upper: wp.array1d[wp.vec3],
    shape_gap: wp.array1d[float],  # Optional per-shape effective gaps (can be empty if AABBs pre-expanded)
    world_index_map: wp.array1d[int],
    world_slice_ends: wp.array1d[int],
    max_shapes_per_world: int,
    # Outputs (1D arrays with manual indexing)
    sap_projection_lower_out: wp.array1d[float],
    sap_projection_upper_out: wp.array1d[float],
    sap_sort_index_out: wp.array1d[int],
):
...
def _sap_range_kernel(
    world_slice_ends: wp.array1d[int],
    max_shapes_per_world: int,
    sap_projection_lower_in: wp.array1d[float],
    sap_projection_upper_in: wp.array1d[float],
    sap_sort_index_in: wp.array1d[int],
    sap_range_out: wp.array1d[int],
):
    world_id, local_shape_id = wp.tid()
...
def _sap_broadphase_kernel(
    ...
    shape_bounding_box_upper: wp.array1d[wp.vec3],
    shape_gap: wp.array1d[float],  # Optional per-shape effective gaps (can be empty if AABBs pre-expanded)
    collision_group: wp.array1d[int],
    shape_world: wp.array1d[int],  # World indices
    world_index_map: wp.array1d[int],
    world_slice_ends: wp.array1d[int],
    sap_sort_index_in: wp.array1d[int],  # 1D array with manual indexing
    sap_cumulative_sum_in: wp.array1d[int],  # Flattened [world_count * max_shapes]
    world_count: int,
    max_shapes_per_world: int,
    nsweep_in: int,
