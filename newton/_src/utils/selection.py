...
def find_matching_ids(
    ...
    matching_ids = match_labels(labels, pattern, pattern_syntax=pattern_syntax)
        ...
        *,
        ...
        if include_joints is None and include_joint_types is None:
            ...
            if include_joints is not None:
                matching_joint_indices = match_names_or_labels(
                    arti_joint_names,
                    arti_joint_labels,
                    include_joints,
                    pattern_syntax=pattern_syntax,
        ...
        if include_links is None:
            ...
            matching_link_indices = match_names_or_labels(
                arti_link_names,
                arti_link_labels,
                include_links,
                pattern_syntax=pattern_syntax,
