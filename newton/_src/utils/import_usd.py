...
def parse_usd(
    ...
    *,
    ...
    Returns:
        ...
        with the matching ``[start, end)`` range lists); :meth:`replicate` keeps the ranges valid
        per world. The material attributes are returned as authored in the ``path_*_attrs``
        entries below.
    ...
    # the consumed curves; the attachment pass below skips the consumed junctions.
    consumed_cable_curve_paths, consumed_junction_attachment_paths = _deformable_import_cable_graphs(_deformable_ctx)
