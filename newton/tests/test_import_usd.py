...
"""
        ...
        self.assertTrue(found_explicit_1, f"Expected margin {expected_explicit_1} not found in model")
        self.assertTrue(found_default, f"Expected default margin {expected_default} not found in model")
        self.assertTrue(found_explicit_2, f"Expected margin {expected_explicit_2} not found in model")
