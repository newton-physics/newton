...
class RobotComposerSim:
    ...
    def _build_ur5e_mjcf_with_base_joint_and_robotiq_gripper_mjcf(self, builder, pos):
        ...
        ur5e_with_robotiq_gripper.joint_act_mode[:3] = [int(JointTargetMode.POSITION)] * 3
        ...
        ur5e_with_robotiq_gripper.joint_act_mode[-6:] = [int(JointTargetMode.POSITION)] * 6
        ...
        for i in self.robotiq_gripper_dofs:
            ...
            ur5e_with_robotiq_gripper.joint_act_mode[idx] = int(JointTargetMode.POSITION)
    ...
    def _build_ur5e_mjcf_with_base_joint_and_leap_hand_mjcf(self, builder, pos):
        ...
        ur5e_with_hand.joint_act_mode[:3] = [int(JointTargetMode.POSITION)] * 3
        ...
        ur5e_with_hand.joint_act_mode[-6:] = [int(JointTargetMode.POSITION)] * 6
    ...
    def _build_franka_urdf_with_base_joint_and_allegro_hand_mjcf(self, builder, pos):
        ...
        franka_with_hand.joint_act_mode[:3] = [int(JointTargetMode.POSITION)] * 3
        ...
        franka_with_hand.joint_act_mode[-7:] = [int(JointTargetMode.POSITION)] * 7
    ...
    def _build_ur10_usd_with_base_joint(self, builder, pos):
        ...
        ur10_builder.joint_act_mode[:3] = [int(JointTargetMode.POSITION)] * 3
        ...
        ur10_builder.joint_act_mode[-6:] = [int(JointTargetMode.POSITION)] * 6
