...
class TestUSDDeformableGroups(unittest.TestCase):
    ...
    def test_replicated_groups_offset_ranges_per_world(self):
        ...
        _bind_deformable_material(stage, cloth.GetPrim(), "/World/ClothMat", surfaceThickness=0.001)
    ...
    def test_heterogeneous_worlds_keep_world_tags(self):
        ...
        _bind_deformable_material(cloth_stage, cloth.GetPrim(), "/World/ClothMat", surfaceThickness=0.001)
