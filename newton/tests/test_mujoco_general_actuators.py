...
class TestMuJoCoActuators(unittest.TestCase):
    ...
    def test_parsing_ctrl_direct_false(self):
        ...
        for i in range(6):
            self.assertEqual(builder.joint_act_mode[i], int(JointTargetMode.NONE))
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_motor")], int(JointTargetMode.NONE))
        self.assertEqual(
            builder.joint_act_mode[get_qd_start(builder, "joint_pos_vel")], int(JointTargetMode.POSITION_VELOCITY)
        )
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_position")], int(JointTargetMode.POSITION))
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_velocity")], int(JointTargetMode.VELOCITY))
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_general")], int(JointTargetMode.NONE))
        ...
        for i in range(6):
            self.assertEqual(joint_act_mode[i], int(JointTargetMode.NONE))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_motor")], int(JointTargetMode.NONE))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_pos_vel")], int(JointTargetMode.POSITION_VELOCITY))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_position")], int(JointTargetMode.POSITION))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_velocity")], int(JointTargetMode.VELOCITY))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_general")], int(JointTargetMode.NONE))
    ...
    def test_parsing_ctrl_direct_true(self):
        ...
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_motor")], int(JointTargetMode.NONE))
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_pos_vel")], int(JointTargetMode.NONE))
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_position")], int(JointTargetMode.NONE))
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_velocity")], int(JointTargetMode.NONE))
        self.assertEqual(builder.joint_act_mode[get_qd_start(builder, "joint_general")], int(JointTargetMode.NONE))
        ...
        joint_act_mode = model.joint_act_mode.numpy()
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_motor")], int(JointTargetMode.NONE))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_pos_vel")], int(JointTargetMode.NONE))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_position")], int(JointTargetMode.NONE))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_velocity")], int(JointTargetMode.NONE))
        self.assertEqual(joint_act_mode[get_qd_start(builder, "joint_general")], int(JointTargetMode.NONE))
    ...
    def test_combined_joint_per_dof_actuators(self):
        ...
        self.assertEqual(builder.joint_act_mode[6], int(JointTargetMode.POSITION))
        ...
        self.assertEqual(builder.joint_act_mode[7], int(JointTargetMode.POSITION))
        ...
        self.assertEqual(builder.joint_act_mode[8], int(JointTargetMode.VELOCITY))
