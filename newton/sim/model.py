...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        """Source geometry source pointer which can be generated by finalizing the geometry objects, see for example :meth:`newton.geometry.Mesh.finalize`, shape [shape_count], uint64."""
