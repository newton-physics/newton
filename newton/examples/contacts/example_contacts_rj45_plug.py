...
LATCH_LIMIT_KD = 1e-4  # dimensionless limit damping (VBD: D = kd * limit_ke)
...
class Example:
    def __init__(self, viewer):
        ...
        builder.default_shape_cfg.ke = CABLE_KE
        builder.default_shape_cfg.kd = CABLE_KD
        builder.default_shape_cfg.mu = CABLE_MU
    ...
    def render(self):
        ...
        self.viewer.log_gizmo("plug", self.gizmo_tf, rotate=newton.GizmoAxes.NONE)
