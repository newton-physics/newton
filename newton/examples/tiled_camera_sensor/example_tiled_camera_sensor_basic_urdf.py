...
from newton.viewer import Camera
...
class Example:
    def __init__(self, viewer, num_worlds):
        ...
        self.fixed_camera = Camera(45.0, width=64, height=64, pos=(0.39906558, 1.6464773, 0.9259162))
        self.fixed_camera.pitch = -14.0
        self.fixed_camera.yaw = -110
