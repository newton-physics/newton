...
from newton.solvers import SolverImplicitMPM, SolverProxyCoupled, SolverVBD
...
class Example:
    ...
    def create_parser():
        ...
        parser.add_argument(
            "--proxy-mass-scale",
            help="Virtual mass scale applied to the VBD proxy particles inside the MPM view",
            type=float,
            default=0.5,
        )
        parser.add_argument(
