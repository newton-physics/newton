...
def main():
    ...
    example_map = {
        ...
        "cable_bend": "newton.examples.cable.example_cable_bend",
        "cable_twist": "newton.examples.cable.example_cable_twist",
        "cable_helix": "newton.examples.cable.example_cable_helix",
