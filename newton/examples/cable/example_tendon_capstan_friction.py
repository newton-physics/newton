...
# The pulleys use explicit high inertia and the vertically constrained
# weights keep a fixed orientation and remain on their respective sides.
...
class Example:
    def __init__(self, viewer, args):
        ...
        vertical_lin = [Dof(axis=Axis.Z, limit_lower=-1.25, limit_upper=1.25)]
        fixed_ang = []
        ...
        for mu, x_off in zip(self.mus, self.x_offsets, strict=True):
            ...
            left_pos = wp.vec3(x_off - 0.7, 0.0, 2.0)
            ...
            j1 = builder.add_joint_d6(
                parent=-1,
                child=left,
                linear_axes=vertical_lin,
                angular_axes=fixed_ang,
            ...
            right_pos = wp.vec3(x_off + 0.7, 0.0, 2.0)
