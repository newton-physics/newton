...
#
# Example usage:
# python -m newton.examples basic_hello_world_with_viewer
# uv run newton/examples/basic/example_basic_hello_world_with_viewer.py
#
###########################################################################
...
class Example:
    def __init__(self, viewer):
        ...
        # setup viewer, also works standalone for null viewer
        self.viewer = viewer
