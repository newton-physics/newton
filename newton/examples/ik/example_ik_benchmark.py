...
class Example:
    ...
    def __init__(self, viewer, repeats, batch_sizes):
    ...
    def _create_robot(self) -> newton.Model:
        ...
        self.parser(asset_path, builder, floating=False)
    ...
    def run_benchmark(self):
        ...
        for batch in self.batch_sizes:
            ...
            best_d = wp.zeros(batch, dtype=int)

            # Pre-compile or capture CUDA graph for the full batch operation
...
def main():
    base = newton.examples.create_parser()
    ...
    parser.add_argument(
        "--batch-sizes",            # note: hyphenated flag => args.batch_sizes
        type=int,
        nargs="+",
    ...
    with wp.ScopedDevice(args.device):
        example = Example(viewer, repeats=args.repeats, batch_sizes=args.batch_sizes)
