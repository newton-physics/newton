...
# ==============================================================================
# BVH-based Particle vs Triangle Collision (Broadphase + Narrowphase)
# ==============================================================================
...
class Example:
    def __init__(self, viewer, args=None):
        ...
        particle_spacing = 0.025  # rest length between particles
        particle_mass = 0.1
        ...
        # Build BVH for efficient particle-triangle collision detection
        # Compute triangle AABBs for the static mesh
        ...
        # Create BVH from triangle AABBs (only done once since mesh is static)
