...
| Compute Jacobians (banded) | `ComputeJacobians_DirectElasticRodConstraintsBanded` | Native | Not ported yet |
| Assemble JMJT (banded) | `AssembleJMJT_DirectElasticRodConstraintsBanded` | Native | Not ported yet |
| Project JMJT (banded) | `ProjectJMJT_DirectElasticRodConstraintsBanded` | Native | Not ported yet |
| Project direct (non-banded) | `ProjectDirectElasticRodConstraints` | Native | Not ported yet |
