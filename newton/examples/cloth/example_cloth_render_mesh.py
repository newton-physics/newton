...
###########################################################################
# Example Cloth Render Mesh
#
# A simulated cloth grid drives a textured render mesh that shares its
# topology. The render mesh is bound per-particle to the cloth and skinned
...
# (cloth) path of the deformable render-mesh workflow
# (https://github.com/newton-physics/newton/issues/3223).
#
# Command: uv run -m newton.examples cloth_render_mesh
#
###########################################################################
...
class Example:
    def __init__(self, viewer, args):
        ...
        # Render mesh shares the cloth topology: bind render vertex i to cloth
        ...
        builder.add_deformable_render_mesh(
            ...
            indices,
            kind="cloth",
            particle_indices=np.arange(particle_start, particle_start + particle_count, dtype=np.int32),
