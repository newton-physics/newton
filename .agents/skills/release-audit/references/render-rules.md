...
- **Behavioral & Support Changes** section: group by topic with short descriptive titles (e.g., "Deterministic contact ordering", "Dependency pins", "Build requirements"). The audit synthesizes the titles from the entry content.
