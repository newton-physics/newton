...
enums are nested under \texttt{CouplingInterface} so the public
\texttt{newton.solvers} namespace exports one coupling entry point rather than a
family of top-level helper symbols.
