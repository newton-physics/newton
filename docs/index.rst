...
.. The toctree below is auto-generated by ``docs/generate_api.py`` from its
.. ``MODULES`` list. To add an API page, add the module to ``MODULES`` and
.. re-run the script — hand edits between the markers will be overwritten.
